...
if (!class_exists('techalgospotlight_Customizer_Widget')):

	/**
	 * techalgospotlight Customizer widget class
	 */
	class techalgospotlight_Customizer_Widget
	{
		...
		public function __construct($args = array())
		{
			...
			$this->option_name = 'techalgospotlight_customizer_widget_' . $this->id_base;
		...
		public function template()
		{
			?>
			<div class="widget"
				id="techalgospotlight_widget-<?php echo esc_attr($this->id_base); ?>-<?php echo esc_attr($this->number); ?>"
				data-widget-base="<?php echo esc_attr($this->id_base); ?>" data-widget-type="<?php echo esc_attr($this->type); ?>">

				<div class="widget-top">

					<div class="widget-title-action">
						<button type="button" class="widget-action" aria-expanded="false">
							<span class="screen-reader-text"><?php esc_html_e('Edit widget:', 'techalgospotlight'); ?>
								<?php echo esc_html($this->name); ?></span>
					...
					<div class="form">
						<div class="widget-content">
							...
							<?php if (isset($this->locations) && is_array($this->locations) && !empty($this->locations)) { ?>
								...
								<p>
									<label
										for="techalgospotlight-widget-location"><?php esc_html_e('Widget Location', 'techalgospotlight'); ?></label>

									<span class="buttonset">
										<?php foreach ($this->locations as $id => $name) { ?>
											<input class="switch-input screen-reader-text" type="radio" value="<?php echo esc_attr($id); ?>"
												...
												<?php checked($id, $current_location, true); ?> data-option-name="location">
							...
							<?php if (isset($this->visibility) && is_array($this->visibility) && !empty($this->visibility)) { ?>
								...
								<p>
									<label
										for="techalgospotlight-widget-visibility"><?php esc_html_e('Visibility', 'techalgospotlight'); ?></label>

									<select
										name="_customize-widget-visibility-<?php echo esc_attr($this->number); ?>-<?php echo esc_attr($this->id); ?>"
										id="<?php echo esc_attr($this->id) . '-' . esc_attr($this->number); ?>" data-option-name="visibility">
						...
						<div class="widget-control-actions">
							<div class="alignleft">
								<button type="button"
									class="button-link button-link-delete widget-control-remove"><?php esc_html_e('Delete', 'techalgospotlight'); ?></button>
								<span class="widget-control-close-wrapper">
									|
									<button type="button"
										class="button-link widget-control-close"><?php esc_html_e('Done', 'techalgospotlight'); ?></button>
								</span>
							</div>
