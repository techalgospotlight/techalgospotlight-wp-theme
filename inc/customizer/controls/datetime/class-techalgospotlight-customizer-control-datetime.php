...
if (!class_exists('techalgospotlight_Customizer_Control_Datetime')):
	/**
	 * techalgospotlight Customizer custom select control class.
	 */
	class techalgospotlight_Customizer_Control_Datetime extends techalgospotlight_Customizer_Control
	{
		 ...
		 * @var string
		 */
		public $type = 'techalgospotlight-datetime';
