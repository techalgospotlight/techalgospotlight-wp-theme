<?php
/**
 * techalgospotlight Customizer custom color control class.
 *
...
if (!class_exists('techalgospotlight_Customizer_Control_Color')):
	/**
	 * techalgospotlight Customizer custom color control class.
	 */
	class techalgospotlight_Customizer_Control_Color extends techalgospotlight_Customizer_Control
	{
		 ...
		 * @var string
		 */
		public $type = 'techalgospotlight-color';
		...
		{
			?>
			<div class="techalgospotlight-color-wrapper techalgospotlight-control-wrapper">
				...
				<# if ( data.label ) { #>
					...
					<# } #>
						...
						<div>
							<input class="techalgospotlight-color-control" type="text" value="{{ data.value }}"
