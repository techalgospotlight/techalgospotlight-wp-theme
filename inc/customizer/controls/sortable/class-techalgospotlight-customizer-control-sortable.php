...
if (!class_exists('techalgospotlight_Customizer_Control_Sortable')):
	/**
	 * techalgospotlight Customizer custom select control class.
	 */
	class techalgospotlight_Customizer_Control_Sortable extends techalgospotlight_Customizer_Control
	{
		 ...
		 * @var string
		 */
		public $type = 'techalgospotlight-sortable';
		...
		{
			?>
			<div class="techalgospotlight-control-wrapper techalgospotlight-sortable-wrapper">
				...
				<ul class="techalgospotlight-sortable-control">
					<# for ( key in data.value ) { #>
						<li
							class="techalgospotlight-sortable-item<# if ( _.has( data.value, key) && ! data.value[ key ] || ! _.has( data.value, key ) && _.has( data.default, key ) && ! data.default[ key ] ) { #> invisible<# } #>"
							data-value="{{ key }}">
							<# if ( data.sortable ) { #>
