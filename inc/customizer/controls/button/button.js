(function ($) {
  wp.customize.controlConstructor["techalgospotlight-button"] =
      ...
      ready: function () {
        ...
        control.container.on("click", ".button", function (e) {
          ...
          if (action) {
            ...
            var data = {
              _ajax_nonce: techalgospotlight_customizer_localized.wpnonce,
              action: action,
            };

            $.post(
              techalgospotlight_customizer_localized.ajaxurl,
              data,
              function (response) {
                // Check response
                if (response.success) {
