(function ($) {
  ...
  wp.customize.controlConstructor["techalgospotlight-design-options"] =
    wp.customize.Control.extend({
      ready: function () {
          ...
          function (e) {
            ...
            var image = wp
              ...
              .on("select", function () {
                ...
                control.container
                  .find('[data-option="background-image"]')
                  .val(imageUrl);
                control.container
                  .find('[data-option="background-image-id"]')
                  .val(imageID);
        ...
        control.container.on(
          "click",
          ".techalgospotlight-spacing-linked",
          function () {
            // Set up variables
            var $this = $(this);
        ...
        control.container.find(".reset-defaults").on("click", function () {
          ...
          control.container
            .find(".background-image-upload-remove-button")
            .click();
