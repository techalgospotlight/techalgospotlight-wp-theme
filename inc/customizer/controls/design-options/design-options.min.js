        ...
        control.container
          ...
          control.container
            ...
            .on("change keyup", function () {
              control.autocorrect_range_input_number($(this), 1e3, undefined);
            })
            .on("focusout", function () {
              control.autocorrect_range_input_number($(this), 0, undefined);
            }),
        ...
        control.container.find(".background-image-advanced").hide(),
            ...
            function (e) {
              ...
              var image = wp
                .media({
                  ...
                  button: { text: control.params.l10n.image.use_image },
                })
                .open()
                .on("select", function () {
                  var previewImage,
          ...
          control.container.find(".reset-defaults").on("click", function () {
            ...
            control.container.find("[data-option]").each(function () {
              (item = $(this)),
                "background-size" === (option_id = item.data("option")) ||
      ...
      update_value: function () {
        ...
        this.container.find("[data-option]").each(function () {
          (option = $(this).data("option")),
            (value[option] =
              "background-size" === option || "background-attachment" === option
                ? $(this).is(":checked")
                  ? $(this).val()
                  : value[option]
                : $(this).val());
