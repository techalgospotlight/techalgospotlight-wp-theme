(function ($) {
  ...
  var techalgospotlightDependencies = {
    listenTo: {},
    ...
    init: function () {
      ...
      wp.customize.control.each(function (control) {
        self.showtechalgospotlightControl(control);
      });
          ...
          wp.customize(master, function (setting) {
            var setupControl = function (control) {
              ...
              isDisplayed = function () {
                return self.showtechalgospotlightControl(
                  wp.customize.control(slave)
                );
              };
     ...
     * @returns {bool}
     */
    showtechalgospotlightControl: function (control) {
      var self = this,
        show = true,
        i;
     ...
     *
     * @since 1.0.0
     * @param {Object} requirement - The requirement, inherited from showtechalgospotlightControl.
    ...
    checkCondition: function (requirement, control, relation) {
      ...
      if (
        ...
        "undefined" === typeof requirement.control
      ) {
        nestedItems = [];
      ...
      self.listenTo[requirement.control] =
        self.listenTo[requirement.control] || [];
  ...
  }; // END var techalgospotlightDependencies

  $(document).ready(function () {
    techalgospotlightDependencies.init();
  });
})(jQuery);
