...
if (!class_exists('techalgospotlight_Jetpack')):
	/**
	 * Jetpack compatibility class.
	 */
	class techalgospotlight_Jetpack
	{
		...
		{
			return '<a href="https://wordpress.org/" rel="noopener noreferrer" target="_blank">' . esc_html__('Proudly powered by WordPress', 'techalgospotlight') . '</a> | <a href="https://peregrine-themes.com/" rel="noopener noreferrer" target="_blank">TechAlgoSpotlight Themes</a>';
		}
		...
		public function filter_infinite_scroll_js_settings($settings)
		{
			...
			$settings['text'] = esc_html__('Load More', 'techalgospotlight');
