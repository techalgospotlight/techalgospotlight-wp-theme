...
if (!class_exists('techalgospotlight_Meta_Boxes')):

	/**
	 * Meta Boxes Class.
	 */
	class techalgospotlight_Meta_Boxes
	{
		...
		public function metabox_config()
		{
			...
			// Sidebar position.
			$layout_settings['techalgospotlight_sidebar_position'] = array(
				'id' => 'techalgospotlight_sidebar_position',
				'name' => esc_html__('Sidebar', 'techalgospotlight'),
				'type' => 'select',
				'default' => 'default',
				'choices' => array(
					'' => esc_html__('Default (from Customizer)', 'techalgospotlight'),
			...
			// Content layout.
			$layout_settings['techalgospotlight_content_layout'] = array(
				'id' => 'techalgospotlight_content_layout',
				'name' => esc_html__('Content Layout', 'techalgospotlight'),
				'type' => 'select',
				'default' => 'default',
				'choices' => array(
					'' => esc_html__('Default (from Customizer)', 'techalgospotlight'),
			...
			$layout_settings['techalgospotlight_page_sections'] = array(
				'id' => 'techalgospotlight_page_sections',
				'type' => 'group',
				'fields' => array(),
			);

			// Disable Top Bar.
			if (techalgospotlight_option('top_bar_enable')) {
				$layout_settings['techalgospotlight_page_sections']['fields']['techalgospotlight_disable_topbar'] = array(
					'id' => 'techalgospotlight_disable_topbar',
					'name' => esc_html__('Disable Top Bar', 'techalgospotlight'),
					'default' => false,
					'type' => 'checkbox',
				);
			}
			...
			// Disable Header.
			$layout_settings['techalgospotlight_page_sections']['fields']['techalgospotlight_disable_header'] = array(
				'id' => 'techalgospotlight_disable_header',
				'name' => esc_html__('Disable Main Header', 'techalgospotlight'),
				'default' => false,
				'type' => 'checkbox',
			);
			...
			if (techalgospotlight_option('page_header_enable')) {
				$layout_settings['techalgospotlight_page_sections']['fields']['techalgospotlight_disable_page_title'] = array(
					'id' => 'techalgospotlight_disable_page_title',
					'name' => esc_html__('Disable Page Title', 'techalgospotlight'),
					'default' => false,
					'type' => 'checkbox',
				);
			}
			...
			if (techalgospotlight_option('page_header_enable') && techalgospotlight_option('breadcrumbs_enable') && !techalgospotlight_is_section_disabled(techalgospotlight_option('breadcrumbs_hide_on'), get_the_ID())) {
				$layout_settings['techalgospotlight_page_sections']['fields']['techalgospotlight_disable_breadcrumbs'] = array(
					'id' => 'techalgospotlight_disable_breadcrumbs',
					'name' => esc_html__('Disable Breadcrumbs', 'techalgospotlight'),
					'default' => false,
					'type' => 'checkbox',
				);
			}
			...
			$layout_settings['techalgospotlight_page_sections']['fields']['techalgospotlight_disable_thumbnail'] = array(
				'id' => 'techalgospotlight_disable_thumbnail',
				'name' => esc_html__('Disable Featured Image', 'techalgospotlight'),
				'default' => false,
				'type' => 'checkbox',
			);
			...
			if (techalgospotlight_option('enable_footer')) {
				$layout_settings['techalgospotlight_page_sections']['fields']['techalgospotlight_disable_footer'] = array(
					'id' => 'techalgospotlight_disable_footer',
					'name' => esc_html__('Disable Main Footer', 'techalgospotlight'),
					'default' => false,
					'type' => 'checkbox',
				);
			}
			...
			if (techalgospotlight_option('enable_copyright')) {
				$layout_settings['techalgospotlight_page_sections']['fields']['techalgospotlight_disable_copyright'] = array(
					'id' => 'techalgospotlight_disable_copyright',
					'name' => esc_html__('Disable Copyright Bar', 'techalgospotlight'),
					'default' => false,
					'type' => 'checkbox',
				);
			}
			...
			// Set metabox options.
			$this->metabox = array(
				'techalgospotlight-theme-page-options' => array(
					'id' => 'techalgospotlight-theme-page-options',
					'post_type' => $this->get_post_types(),
					'capability' => 'edit_posts',
					'label' => esc_html__('Theme Page Options', 'techalgospotlight'),
					'context' => 'side',
					'priority' => 'core',
			...
			$this->metabox = apply_filters('techalgospotlight_metabox_options', $this->metabox);
		}
		...
		public function render($post, $metabox)
		{
			...
			foreach ($metabox['args']['settings'] as $setting) {
				...
				echo '<div class="techalgospotlight-meta-box-field">';
			...
			<div class="components-base-control">
				<div class="components-base-control__field">
					...
					<?php if (isset($setting['name'])) { ?>
						<label class="post-attributes-label-wrapper components-base-control__label"
							for="<?php echo esc_attr($setting['id']); ?>">
					...
					<select name="<?php echo esc_attr($setting['id']); ?>" id="<?php echo esc_attr($setting['id']); ?>">
						<?php foreach ($setting['choices'] as $key => $value) { ?>
							<option value="<?php echo esc_attr($key); ?>" <?php selected($saved_value, $key); ?>>
		...
		public function render_field_checkbox($post, $setting)
		{
			...
			?>
			<div class="components-panel__row techalgospotlight-checkbox-row">
				<div class="components-base-control">
					<div class="components-base-control__field">
						<span class="components-checkbox-control__input-container techalgospotlight-checkbox-wrapper">
							<input type="checkbox" class="components-checkbox-control__input" id="<?php echo esc_attr($setting['id']); ?>"
								name="<?php echo esc_attr($setting['id']); ?>" <?php checked($saved, true); ?>>
							<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" role="img"
								class="techalgospotlight-checked-icon components-checkbox-control__checked" aria-hidden="true"
								focusable="false">
								<path d="M9 18.6L3.5 13l1-1L9 16.4l9.5-9.9 1 1z"></path>
							</svg>
						</span>
						<label class="components-checkbox-control__label"
							for="<?php echo esc_attr($setting['id']); ?>"><?php echo esc_html($setting['name']); ?></label>
					</div>
				</div>
			</div>
			<?php
		...
		public function render_field_textarea($post, $setting)
		{
			...
			<div class="components-base-control">
				<div class="components-base-control__field">
					...
					<textarea class="widefat" id="<?php echo esc_attr($setting['id']); ?>"
						name="<?php echo esc_attr($setting['id']); ?>" rows="5"><?php echo wp_kses_post($saved); ?></textarea>
		...
		public function render_field_text($post, $setting)
		{
			...
			<div class="components-base-control">
				<div class="components-base-control__field">
					...
					<input type="text" class="widefat" id="<?php echo esc_attr($setting['id']); ?>"
						name="<?php echo esc_attr($setting['id']); ?>" value="<?php echo wp_kses_post($saved); ?>" />
		...
		public function load_assets($hook)
		{
			...
			if ('post-new.php' === $hook || 'post.php' === $hook) {
				...
				if (in_array($post_type, $post_types, true)) {
					...
					wp_enqueue_style(
						'techalgospotlight-metabox-style',
						techalgospotlight_THEME_URI . '/inc/admin/assets/css/techalgospotlight-meta-boxes' . $techalgospotlight_suffix . '.css',
						false,
...
/**
 * The function which returns the one techalgospotlight Meta Boxes instance.
 *
 ...
 * @return object
 */
function techalgospotlight_meta_boxes()
{
	return techalgospotlight_Meta_Boxes::get_instance();
}

techalgospotlight_meta_boxes();
